...
import (
    ...
    "github.com/Yuttachai-101/api_tiktok/models/fulfillment/v202309"
)
...
Use this API to confirm an order split. Please note, this API only supports order splits for different SKUs. Splitting orders at the item level is not supported. 

Here is an example of a supported order split.  A buyer places an order that contains the following items and quantities: 
- SKU 1 Red T-Shirt - Size L, quantity: 2 
- SKU 2: Blue Jeans - Size 32, quantity: 1 
